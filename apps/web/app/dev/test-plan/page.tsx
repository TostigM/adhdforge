...
/**
 * M4 Interactive Test Plan
 * Dev-only page — only renders in development mode.
 * Live at: http://localhost:3001/dev/test-plan
 */
...
const ACCEPTANCE_CRITERIA = [
  ...
  { id: 'ac_complete', label: 'Complete task → "Done. Next step." → task removed', auto: false },
...
const SMOKE_STEPS = [
  ...
  { id: 'sm_card', label: 'TaskCard renders', detail: 'TaskCard appears with text "Buy oranges" and a Silver priority pill. Actions visible: "Done. Next step." and "Push to later".' },
  { id: 'sm_complete', label: 'Complete a task', detail: 'Click "Done. Next step." → TaskCard disappears. Success toast shows. First Complete badge may also appear.' },
...
export default function M4TestPlanPage() {
